...
using Cursos.Application.ExteralEvents.Matriculas.MatriculaCreada;
using Cursos.Application.ExteralEvents.Matriculas.MatriculaError;
using MediatR;
...
public class RabbitMQEventListener : BackgroundService
{
         ...
         ILogger<RabbitMQEventListener> logger)
    {
        ...
        _channel.QueueDeclare(queue: "CursosQueue", durable: true, exclusive: false, autoDelete: false, arguments: null);
