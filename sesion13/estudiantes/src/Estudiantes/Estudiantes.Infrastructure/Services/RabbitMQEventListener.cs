...
using Estudiantes.Application.ExternalEvents.Cursos.CursosConCupo;
using Estudiantes.Application.ExternalEvents.Cursos.CursosSinCupo;
using MediatR;
...
public class RabbitMQEventListener: BackgroundService
{
        ...
        ILogger<RabbitMQEventListener> logger)
    {
       ...
       _channel.ExchangeDeclare(exchange: "CursosEstudiantesExchange", type: "fanout", durable: true);
        ...
        _channel.QueueBind(queue: "EstudiantesQueue", exchange: "CursosEstudiantesExchange", routingKey: "");
